...
const ServiceType = ({label, description, image, value}: ServiceTypeProps) => {
  return (
    <div>
      ...
      <Label
        htmlFor={value}
        className="cursor-pointer flex bg-white items-center gap-2 justify-between rounded-md border-2 hover:border-rose-500 peer-data-[state=checked]:border-rose-500"
      >
